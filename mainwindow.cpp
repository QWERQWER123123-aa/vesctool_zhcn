    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->actionRemoveDownloadedConfigs->setIcon(Utility::getIcon("icons/Delete-96.png"));
    ...
    fwMenu->setTitle(tr("Load Firmware Configs"));
    ...
    auto reloadBackupMenu = [this, backupMenu]() {
        backupMenu->clear();
        backupMenu->setTitle(tr("Load Configuration Backups for UUID"));
...
void MainWindow::reloadPages()
{
    ...
    addPageItem(tr("CAN Tools"),  theme + "icons/can_off.png", "", false, true);
...
void MainWindow::on_actionRemoveDownloadedConfigs_triggered()
{
    mVesc->removeDownloadedConfigs();
}