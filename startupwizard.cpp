    ...
    : QWizardPage(parent)
{
    ...
    if (p != 0) {
        setTitle(QCoreApplication::translate("ConfigParams", p->longName.toUtf8().constData()));
        mBrowser->setHtml(QCoreApplication::translate("ConfigParams", p->description.toUtf8().constData()));
    } else {
