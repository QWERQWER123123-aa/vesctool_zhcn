    ...
    ui(new Ui::Preferences)
{
    ...
    QString savedLang = mSettings.value("app_language", "zh").toString();
    ui->languageBox->setCurrentIndex(savedLang == "en" ? 0 : 1);
...
void Preferences::on_languageBox_currentIndexChanged(int index)
{
    mSettings.setValue("app_language", index == 0 ? "en" : "zh");
    mSettings.sync();
}
